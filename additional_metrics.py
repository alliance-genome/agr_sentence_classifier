...
# Define file path
type_of_data = 'expression_data'  # Ensure this matches the file naming convention in your main script
output_file_path = f'classification_results_{type_of_data}.tsv'
